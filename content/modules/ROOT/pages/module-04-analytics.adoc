...
Now that you've consumed the MaaS model, let's see how the platform tracks usage.

== View the Grafana Dashboard

1. From the cluster apps menu, select **Grafana**

image::grafana-app.png[]

2. Select the **grafana** dashboard
...
**Your activity is here** - the Rocket.Chat interactions you just did in the playground generated tokens, and they're being tracked in this dashboard.
